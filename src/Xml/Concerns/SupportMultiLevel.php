...
namespace Caleido\Parser\Xml\Concerns;

use SimpleXMLIterator;
use Tightenco\Collect\Support\Arr;
use function Caleido\Parser\alias_get;
use Caleido\Parser\Xml\Definitions\MultiLevel;
...
trait SupportMultiLevel
{
     ...
     * @param  string  $use
     *
     * @return \Caleido\Parser\Xml\Definitions\MultiLevel|string
     */
     ...
     * @param  string  $value
     *
     * @return \Caleido\Parser\Xml\Definitions\MultiLevel
     */
     ...
     * @param  \Caleido\Parser\Xml\Definitions\MultiLevel  $multilevel
     *
     * @return array
     */
    protected function parseMultiLevelsValueCollection(SimpleXMLIterator $content, MultiLevel $multilevel): array
    {
        $value = [];
        $result = [];
